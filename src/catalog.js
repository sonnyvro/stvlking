...
const TRACKS = [
    ...
    { id: 'pushingdawhip', title: 'pushingdawhip', year: '2026', tags: ['trap', 'gritty', 'dark'], initials: 'PD', cover: 'covers/pushingdawhip.jpg', audio: 'pushingdawhip.mp3', details: { bpm: '150', key: 'A min', mood: 'Gritty, driving' } },
    { id: 'arson', title: 'arson', year: '2026', tags: ['cinematic', 'dark', 'ambient'], initials: 'AR', cover: 'covers/arson.jpg', audio: 'arson.mp3', details: { bpm: '128', key: 'D min', mood: 'Cinematic, brooding' } },
    { id: 'haunt', title: 'haunt', year: '2026', tags: ['dark', 'ambient'], initials: 'HA', cover: 'covers/haunt.jpg', audio: 'haunt.mp3', details: { bpm: '140', key: 'F# min', mood: 'Dark, haunting' } },
    { id: 'inthislifeandthenext', title: 'in this life, and the next', year: '2026', tags: ['cinematic', 'ambient'], initials: 'IL', cover: 'covers/inthislifeandthenext.jpg', audio: 'inthislifeandthenext.mp3?v=3', details: { bpm: '128', key: 'D min', mood: 'Cinematic, emotional' } },
    { id: 'killingfloor', title: 'killing floor', year: '2026', tags: ['trap', 'dark', 'gritty'], initials: 'KF', cover: 'covers/killingfloor.jpg', audio: 'killingfloor.mp3?v=3', details: { bpm: '150', key: 'A min', mood: 'Hard, gritty' } },
    { id: 'pentagram', title: 'pentagram', year: '2026', tags: ['dark', 'trap'], initials: 'PE', cover: 'covers/pentagram.jpg', audio: 'pentagram.mp3', details: { bpm: '145', key: 'C min', mood: 'Ominous, dark' } },
    { id: 'reddot', title: 'red dot', year: '2026', tags: ['trap', 'gritty'], initials: 'RD', cover: 'covers/reddot.jpg', audio: 'reddot.mp3', details: { bpm: '148', key: 'G min', mood: 'Sniper, focused' } },
    { id: 'rip', title: 'rip', year: '2026', tags: ['cinematic', 'dark'], initials: 'RI', cover: 'covers/rip.jpg', audio: 'rip.mp3', details: { bpm: '130', key: 'E min', mood: 'Mournful, cinematic' } },
    { id: 'widow', title: 'widow', year: '2026', tags: ['dark', 'ambient'], initials: 'WI', cover: 'covers/widow.jpg', audio: 'widow.mp3', details: { bpm: '138', key: 'B min', mood: 'Cold, brooding' } }
];
...
export const PLAY_ICON = '<polygon points="5 3 19 12 5 21 5 3"></polygon>';
export const PAUSE_ICON = '<rect x="6" y="4" width="4" height="16"></rect><rect x="14" y="4" width="4" height="16"></rect>';
...
let onTrackStarted = null;
export function setOnTrackStarted(fn) { onTrackStarted = fn; }
...
export function wireTrackPlayers() {
    document.querySelectorAll('[data-track-audio]').forEach(audio => {
        ...
        audio.addEventListener('play', () => {
            ...
            if (onTrackStarted) onTrackStarted(true);
            updatePlayIcon();
            recordPlay(trackId);
        });
        ...
        audio.addEventListener('timeupdate', () => {
            if (audio.duration) {
                ...
                if (playerState.currentlyPlayingAudio === audio && miniPlayerProgress) miniPlayerProgress.style.width = pct + '%';
            }
        });
...
export function openBeatDetail(trackId) {
    ...
    beatDetailBody.innerHTML = `
        ...
        <div class="beat-detail-stats">
            <div class="beat-detail-stat"><div class="beat-detail-stat-label">BPM</div><div class="beat-detail-stat-value">${escapeHtml(detail.bpm || '—')}</div></div>
            <div class="beat-detail-stat"><div class="beat-detail-stat-label">Key</div><div class="beat-detail-stat-value">${escapeHtml(detail.key || '—')}</div></div>
            <div class="beat-detail-stat"><div class="beat-detail-stat-label">Year</div><div class="beat-detail-stat-value">${escapeHtml(meta)}</div></div>
        </div>
        <div class="beat-detail-tags">${tags.map(t => `<span class="track-tag">${escapeHtml(t)}</span>`).join('')}</div>
        <div class="beat-detail-lease-row"><div class="beat-detail-lease-info"><div class="beat-detail-lease-name">Basic Lease</div><div class="beat-detail-lease-desc">Tagged MP3 + WAV · 10k streams</div></div><a class="beat-detail-buy" href="https://discord.gg/Mv6FRgD8jQ" target="_blank" rel="noopener">$25</a></div>
        <div class="beat-detail-lease-row"><div class="beat-detail-lease-info"><div class="beat-detail-lease-name">Premium Lease</div><div class="beat-detail-lease-desc">Untagged + stems · 100k streams</div></div><a class="beat-detail-buy" href="https://discord.gg/Mv6FRgD8jQ" target="_blank" rel="noopener">$50</a></div>
        <div class="beat-detail-lease-row"><div class="beat-detail-lease-info"><div class="beat-detail-lease-name">Exclusive</div><div class="beat-detail-lease-desc">Full rights · unlimited · project file</div></div><a class="beat-detail-buy" href="https://discord.gg/Mv6FRgD8jQ" target="_blank" rel="noopener">$100+</a></div>
    `;
    beatDetailBackdrop.classList.add('open');
}

export function closeBeatDetail() {
    document.getElementById('beat-detail-backdrop').classList.remove('open');
}

export function wireDetailButtons() {
...
export async function fetchTrackReactions() {
...
export async function toggleTrackReaction(trackId, emoji) {
    const btn = document.querySelector(`[data-track="${trackId}"][data-emoji="${emoji}"]`);
...
export function wireReactionButtons() {
...
export async function fetchTrackPlays() {
    if (!isConfigured()) return;
    try {
